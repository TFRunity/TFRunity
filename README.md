...
#### Веб разработчик, успевший за свои 19 лет поработать в компании, пройти 1 интенсив| и стажировку в Ростелекоме. Мой путь в IT начался ещё 5 лет назад, когда впервые познакомился с C#, платформой .NET. После этого занял несколько призовых мест в городских олимпиадах и изучил несколько курсов на степике, (далее ссылки). 

___Основные цели на 2026___

- ⤴️ Посмотреть IT-холдинги Чувашии

- 🔡 Заключить контракт о целевом обучении // Найти работу мечты

- 🥇 Получить оффер в IT компанию на ставку junior+
...
<div>
  ...
  <img src="https://github.com/devicons/devicon/blob/master/icons/mysql/mysql-original.svg" width="50" height="50" title="mysql" />&nbsp
  <img src="https://github.com/devicons/devicon/blob/master/icons/python/python-original.svg" width="50" height="50" title="python" />&nbsp
  <img src="https://github.com/devicons/devicon/blob/master/icons/rabbitmq/rabbitmq-original.svg" width="50" height="50" title="rabbitmq" />&nbsp
...
|:---:|:---:|:---:|
|XX.08.2022|XX.07.2024|Обучение основам C# C++ Python |
|21.04.2023|21.04.2023|Олимпиада по программированию в ЧГУ им И.Н. Ульянова|
|15.02.2024|30.03.2024|Прохождение 3 курсов: SQL, PostgreSQL, Vue|
|25.08.2024|03.06.2025|Работа  в ООО Юмакс на позиции младший Веб-разработчик|
...
## P.S. Если вам нужно больше информации по качеству кода - есть закрытые репозитории на next js + react + ts || ASP.NET + Blazor, буду рад предоставить доступ, если его запросят лично через мой ТГ.
